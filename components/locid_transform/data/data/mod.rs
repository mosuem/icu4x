    ...
    ($ provider : ty) => {
        ...
        impl icu_provider::AnyProvider for $provider {
            fn load_any(&self, key: icu_provider::DataKey, req: icu_provider::DataRequest) -> Result<icu_provider::AnyResponse, icu_provider::DataError> {
                icu_provider::impl_dynamic_data_provider!($provider, [icu::locid_transform::provider::LocaleFallbackLikelySubtagsV1Marker, icu::locid_transform::provider::LocaleFallbackParentsV1Marker, icu::locid_transform::provider::CollationFallbackSupplementV1Marker, icu::locid_transform::provider::AliasesV1Marker, icu::locid_transform::provider::LikelySubtagsExtendedV1Marker, icu::locid_transform::provider::LikelySubtagsForLanguageV1Marker, icu::locid_transform::provider::LikelySubtagsForScriptRegionV1Marker, icu::locid_transform::provider::ScriptDirectionV1Marker], icu_provider::AnyMarker);
