...
pub(in crate::provider) struct CldrCache {
    ...
    pub(in crate::provider) transforms: OnceCell<std::sync::Mutex<icu_transliterate::RuleCollection>>,
}
...
impl CldrCache {
    ...
    pub fn locales(
        ...
        Ok(self
            .serde_cache
            .read_and_parse_json::<super::coverage_levels::Resource>(
    ...
    fn locale_expander(&self) -> Result<&LocaleExpander, DataError> {
        use super::super::locale_canonicalizer::likely_subtags::*;
